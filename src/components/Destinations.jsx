    ...
    <section id="destinations" className="py-20 bg-white px-4 sm:px-6 lg:px-20">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="rounded-lg shadow-md overflow-hidden hover:shadow-xl transition transform hover:-translate-y-2">
          <img src={localTrip} alt="Local Tours" loading='lazy' className="w-full h-64 object-cover"/>
          <div className="p-4">
...
>
  Book Now
        ...
        {/* International Trip */}
        <div className="rounded-lg shadow-md overflow-hidden hover:shadow-xl transition transform hover:-translate-y-2">
          <img src={internationalTrip} alt="International Tours" loading='lazy' className="w-full h-64 object-cover"/>
          <div className="p-4">
...
>
  Book Now
        ...
        {/* Group Trip */}
        <div className="rounded-lg shadow-md overflow-hidden hover:shadow-xl transition transform hover:-translate-y-2">
          <img src={groupTrip} alt="Group Trips" loading='lazy' className="w-full h-64 object-cover"/>
          <div className="p-4">
